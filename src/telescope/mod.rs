...
#[rustfmt::skip]
use lenses::{
    AllSeeingEyeLens, AutoCalibrationLens, AutocorrelationLens, BarrierLens, BatteryChemistryLens,
    BigBangLens, BoseEinsteinLens, BoundaryLens, CausalLens, ChaosLens,
    ChipArchitectureLens, ClusteringLens, CompassLens, CompressionLens, ConcaveLens,
    ConformalBootstrapLens, ConsciousnessLens, ConsciousnessOrchestratorLens, ConstantCollectorLens, ConstantCombinationLens,
    ConstantDiscoveryEngineLens, ConstantFormulaLens, ContractingScanLens, ConvexLens, CorrelationLens,
    DensityLens, DestinyLens, DiamondLens, DimensionReductionLens, DimensionalBridgeLens,
    DivergenceLens, ElementCombinationLens, ElementLens, EmLens, EngineDiscoveryLens,
    EntropyLens, EventHorizonLens, EvolutionLens, ExoticMatterLens, ExpandingScanLens,
    FissionLens, FormulaCombinationLens, FractalLens, FusionLens, GodsEyeLens,
    GoldenRatioLens, GoldenZoneLens, GradientLens, GraphLens, GravityLens,
    HexagonalLens, InfiniteDiscoveryLens, InfinityLens, InfoLens, KaleidoscopeLens,
    KeywordLens, LatticeFieldLens, LensDiscoveryLens, LightLens, LightWaveLens,
    LoRALens, MaterialCombinationLens, MemoryLens, MetricDiscoveryLens, MetricLens,
    ...
    RulerLens, ScaleLens, SimulationLens, SingularityLens, SolarEfficiencyLens,
    SpacetimeLens, SpectralLens, SpeculativeDecodeLens, SphericalLens, StabilityLens,
    StationarityLens, StimulusLens, SymmetryBreakingLens, TachyonLens, TelepathyLens,
    TensionLens, TensionLinkLens, ThermoLens, TimeReversalLens, TopologyLens,
    TransformerAnatomyLens, TriangleLens, UbatchUoptimizationLens, UcombinatorialLens, UcompletenessLens,
    UemergenceLens, UextrapolationLens, UflashUattentionUlensLens, UfrustrationLens, UinverseLens,
    UisomorphismLens, UkernelUfusionLens, UperiodicityLens, UsurpriseLens, VoidLens,
    WallInspectionLens, WarpLens, WaveLens, WeightLearningLens, WormholeLens,
};
