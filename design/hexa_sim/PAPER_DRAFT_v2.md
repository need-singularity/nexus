...
### 13.10.3 F132 — cross-engine meta-finding
...
Three multi-decomposition claims are central to §7. Verify arithmetically:

### 13.11.1 F36 codon triple

Already verified in §13.10.1. The codon triple is `64 = 2^6 = 4^3 = tau(6)^3`.

### 13.11.2 F32 + F80 — the 1728 triple
...
### 13.11.3 F28 + F78 — the 23 doublet
