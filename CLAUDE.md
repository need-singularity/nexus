...
L0 Guard: `hexa ~/Dev/nexus/shared/harness/lockdown_gate.hexa <verify|status|watch|repair|safe-merge|log>` (legacy: `shared/harness/l0_guard.hexa` 보존, SUPERSEDED — 2026-04-14 lockdown→harness 완전 이동)
